...
public final class FoodRegistry {
    ...
    public static void register(@Nonnull ExoticGarden plugin, @Nonnull Category misc, @Nonnull Category drinks, @Nonnull Category food) {
        ...
        new CustomFood(food, new SlimefunItemStack("SWEET_POPCORN", "1497b147cfae52205597f72e3c4ef52512e9677020e4b4fa7512c3c6acdd8c1", "&r甜爆米花", "", "&7&o恢复 &b&o" + "6.0" + " &7&o点饥饿值"),
                new ItemStack[] {getItem("CORN"), getItem("BUTTER"), new ItemStack(Material.SUGAR), null, null, null, null, null, null},
                12)
                .register(plugin);

        new CustomFood(food, new SlimefunItemStack("SALTY_POPCORN", "1497b147cfae52205597f72e3c4ef52512e9677020e4b4fa7512c3c6acdd8c1", "&r咸爆米花", "", "&7&o恢复 &b&o" + "6.0" + " &7&o点饥饿值"),
        ...
        new CustomFood(food, new SlimefunItemStack("BACON_WRAPPED_CHEESE_FILLED_HOT_DOG", "33f2d7d7a8b1b969142881eb5a87e737b5f75fb808b9a157adddb2c6aec382", "&r培根奶酪热狗", "&7&o\"当我主厨时\" - @Eyamaz", "", "&7&o恢复 &b&o" + "8.5" + " &7&o点饥饿值"),
                new ItemStack[] {getItem("BACON"), getItem("HOT_DOG"), getItem("BACON"), null, getItem("CHEESE"), null, null, null, null},
                17)
                .register(plugin);

        new CustomFood(food, new SlimefunItemStack("BBQ_BACON_WRAPPED_HOT_DOG", "33f2d7d7a8b1b969142881eb5a87e737b5f75fb808b9a157adddb2c6aec382", "&r烤肉培根热狗", "&7&o\"想聊聊热狗吗?\" - @Pahimar", "", "&7&o恢复 &b&o" + "8.5" + " &7&o点饥饿值"),
                new ItemStack[] {getItem("BACON"), getItem("HOT_DOG"), getItem("BACON"), null, getItem("BBQ_SAUCE"), null, null, null, null},
                17)
                .register(plugin);

        new CustomFood(food, new SlimefunItemStack("BBQ_DOUBLE_BACON_WRAPPED_HOT_DOG_IN_A_TORTILLA_WITH_CHEESE", "33f2d7d7a8b1b969142881eb5a87e737b5f75fb808b9a157adddb2c6aec382", "&r双层烤肉培根裹芝士热狗玉米饼", "&7&o\"当我主厨时\" - @Eyamaz", "", "&7&o恢复 &b&o" + "10.0" + " &7&o点饥饿值"),
